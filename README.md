...
<body>
  ...
  <section id="projects" class="projects">
    ...
    <div class="project">
      <h3>Project One</h3>
      <p>This is a sample description of my project. It showcases responsive design and JavaScript functionality.</p>
    </div>
    <div class="project">
      <h3>Project Two</h3>
  ...
  <section id="contact">
    ...
    <p id="formStatus" style="margin-top: 10px; color: green;"></p>
  </section>
  ...
  <!-- ==== JavaScript ==== -->
  <script>
    // Basic form validation and message display
